...
import '/index.dart';
import 'heart_age_complete_message_widget.dart'
    show HeartAgeCompleteMessageWidget;
import 'package:flutter/material.dart';

class HeartAgeCompleteMessageModel
    extends FlutterFlowModel<HeartAgeCompleteMessageWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetRecommendation)] action in HeartAgeCompleteMessage widget.
  ApiCallResponse? apiResultyop;
