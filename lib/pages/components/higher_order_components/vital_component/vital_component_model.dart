...
class VitalComponentModel extends FlutterFlowModel<VitalComponentWidget> {
  ...
  // Model for ScanPostureFormThree component.
  late ScanPostureFormThreeModel scanPostureFormThreeModel;
  ...
  void initState(BuildContext context) {
    ...
    scanPostureFormThreeModel =
        createModel(context, () => ScanPostureFormThreeModel());
  ...
  void dispose() {
    ...
    scanPostureFormThreeModel.dispose();
