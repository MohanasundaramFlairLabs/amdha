...
import '/pages/components/micro_components/form_components/date_selection/date_selection_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            '${widget.fieldName}${widget.mandatorySymbol}',
          ...
          wrapWithModel(
            ...
            child: DateSelectionWidget(
              ...
              datePicked: (date) async {
                logFirebaseEvent('DATE_PICK_Container_yo5cw8dr_CALLBACK');
