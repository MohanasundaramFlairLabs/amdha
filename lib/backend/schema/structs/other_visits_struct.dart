...
class OtherVisitsStruct extends BaseStruct {
  OtherVisitsStruct({
    List<String>? notes,
    String? tenantId,
    String? internalId,
  ...
  static OtherVisitsStruct fromMap(Map<String, dynamic> data) =>
      OtherVisitsStruct(
  ...
  static OtherVisitsStruct? maybeFromMap(dynamic data) => data is Map
      ? OtherVisitsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static OtherVisitsStruct fromSerializableMap(Map<String, dynamic> data) =>
      OtherVisitsStruct(
  ...
  @override
  String toString() => 'OtherVisitsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is OtherVisitsStruct &&
...
OtherVisitsStruct createOtherVisitsStruct({
  String? tenantId,
  String? internalId,
  String? externalId,
  String? consultedOn,
