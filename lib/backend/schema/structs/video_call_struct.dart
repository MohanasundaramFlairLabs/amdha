...
class VideoCallStruct extends BaseStruct {
  VideoCallStruct({
    int? remaining,
    int? used,
    int? total,
  ...
  static VideoCallStruct fromMap(Map<String, dynamic> data) => VideoCallStruct(
        remaining: castToType<int>(data['remaining']),
        used: castToType<int>(data['used']),
        total: castToType<int>(data['total']),
      );

  static VideoCallStruct? maybeFromMap(dynamic data) => data is Map
      ? VideoCallStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static VideoCallStruct fromSerializableMap(Map<String, dynamic> data) =>
      VideoCallStruct(
  ...
  @override
  String toString() => 'VideoCallStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is VideoCallStruct &&
...
VideoCallStruct createVideoCallStruct({
  int? remaining,
  int? used,
  int? total,
}) =>
