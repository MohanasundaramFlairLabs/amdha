...
class _AddVitalsComponentWidgetState extends State<AddVitalsComponentWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.selectedVital = 'Weight';
      _model.enableSubmitButton = false;
      _model.updatePage(() {});
    });

    _model.enteredVitalTextController ??= TextEditingController(
        text: widget.isEdit! ? widget.vitalToEdit?.value : '   ');
    _model.enteredVitalFocusNode ??= FocusNode();
    _model.enteredVitalFocusNode!.addListener(() => setState(() {}));
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: DropDownFieldWidget(
                      fieldName: 'Select Vital Type',
                      options: FFAppConstants.listofVitals,
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              '${_model.dropDownFieldModel.dropdownModel.dropDownValue} in (${() {
                                if (_model.dropDownFieldModel.dropdownModel
                                        .dropDownValue ==
                                    'Weight') {
                                  return 'KG';
                                } else if (_model.dropDownFieldModel
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    5.0, 0.0, 0.0, 0.0),
                                child: TextFormField(
                                  controller: _model.enteredVitalTextController,
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      _model.apiResultsgw = await AddVitalsCall.call(
                        type: _model.selectedVital,
                        value: _model.enteredVitalTextController.text,
                        lastModified: _model.datePicked2?.millisecondsSinceEpoch
                            .toString(),
                        note: _model.textController2.text,
                      );

                      if ((_model.apiResultsgw?.succeeded ?? true)) {
                        await widget.callback?.call();
                      }
