...
class EducationListComponentWidget extends StatefulWidget {
  ...
  final EducationModelStruct? educationModel;
...
class _EducationListComponentWidgetState
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Builder(
        builder: (context) {
          final listofeduction =
              widget.educationModel?.education.toList() ?? [];
          return Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children:
                List.generate(listofeduction.length, (listofeductionIndex) {
              final listofeductionItem = listofeduction[listofeductionIndex];
              return Container(
                width: 100.0,
                decoration: BoxDecoration(
                  color: FlutterFlowTheme.of(context).secondaryBackground,
                            ...
                            itemBuilder: (context, educationItemIndex) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    await widget.callbackEducationLIst?.call(
                                      educationItemItem,
                                    );
                                  },
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/Medication_Management.png',
                                            width: 300.0,
                                            height: 140.0,
                                            fit: BoxFit.cover,
                                          ),
